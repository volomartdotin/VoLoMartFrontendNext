...
export function SiteFooter() {
  ...
  const socialLinkClass =
    "flex h-8 w-8 items-center justify-center rounded-full bg-[#2a2834] text-[#d7d3de] ring-1 ring-white/5 transition hover:bg-[#353344] hover:text-white";
  const socialDisabledClass =
    "flex h-8 w-8 cursor-default items-center justify-center rounded-full bg-[#2a2834] text-[#d7d3de] ring-1 ring-white/5 opacity-70";
  return (
    <section
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="mt-5 flex flex-wrap gap-2">
              <a
                ...
                onClick={() => handleFooterClick("Facebook", socialLinks.facebook)}
              >
              ...
              <a
                ...
                className={socialLinkClass}
                onClick={() => handleFooterClick("Instagram", socialLinks.instagram)}
              >
                <svg className="h-3.5 w-3.5" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
              ...
              <a
                ...
                aria-label="YouTube"
                className={socialLinkClass}
                onClick={() => handleFooterClick("YouTube", socialLinks.youtube)}
              >
                <svg className="h-3.5 w-3.5" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
                  <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
                </svg>
              </a>
              <span aria-label="Twitter" role="img" className={socialDisabledClass} title="Coming soon">
                <svg className="h-3.5 w-3.5" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
              ...
              <a
                ...
                aria-label="LinkedIn"
                className={socialLinkClass}
                onClick={() => handleFooterClick("LinkedIn", socialLinks.linkedin)}
              >
                <svg className="h-3.5 w-3.5" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
